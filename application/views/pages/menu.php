    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item" style="<?php if($menu == 'dashboard'){echo "background: #506a79;";} ?> ">
        ...
        <li class="nav-item" style="<?php if($menu == 'entradas'){echo "background: #506a79;";} ?> ">
        ...
        <li class="nav-item" style="<?php if($menu == 'saidas'){echo "background: #506a79;";} ?> ">
          ...
          <div id="collapseSaidas" class="collapse" aria-labelledby="headingSaidas" data-parent="#accordionSidebar">
            ...
            <li class="nav-item" style="<?php if($menu == 'dividas'){echo "background: #506a79;";} ?> ">
          ...
          <li class="nav-item" style="<?php if($menu == 'contas'){echo "background: #506a79;";} ?> ">
          ...
          <li class="nav-item" style="<?php if($menu == 'categorias'){echo "background: #506a79;";} ?> ">
