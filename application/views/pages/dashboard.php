          ...
          <div class="row">
            ...
            if ($contas == 0) { ?>
              <div class="border-not">
                <p>Bem-vindo! Voce ainda nao tem nenhuma conta cadastrada, vamos cadastrar?</p>
                <a class="btn btn-primary" href="<?php echo base_url(); ?>/contas">Cadastrar conta</a>
              </div>

            <?php } ?>
            <?php if ($categorias_count == 0) { ?>
              <div class="border-not">
                <p>Bem-vindo! Voce ainda nao tem nenhuma categoria cadastrada, vamos cadastrar?</p>
                <a class="btn btn-primary" href="<?php echo base_url(); ?>/categorias">Cadastrar categorias</a>
              </div>
            <?php } ?>
          </div>
          <!-- End of Main Content -->
